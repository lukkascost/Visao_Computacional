...
gaus_mask = np.array([[0.0947416,0.118318,0.0947416],[0.118318,0.147761,0.118318],[0.0947416,0.118318,0.0947416]])
gaus = convolution3x3(img, gaus_mask)

cv2.imwrite("img/TRABALHO_03/LENA_ALGORITMO.png", gaus)
